...
<html lang="en">
    ...
    <body>
          ...
          <div class="container-fluid">
            ...
            <a class="navbar-brand log" href="dashadmin.php" ><i style="color:rgb(128,255,0);">get</i><i style="color: rgb(0,64,128);">Caregiver</i></a>
          </nav>
            </div>
                    <div class="col-md-7">
                        <nav class="navbar navbar-expand-md navbar-light" >
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                      <ul class="navbar-nav" >
                        <li class="nav-item">
                          <a class="nav-link" href="dashadmin.php" style='color:white; background-color:rgb(0,64,128); '><span class="fas fa-home"></span> My Dashboard</a>
                        </li>
                        <li class="nav-item">
             ...
             <li class="nav-item">
                            ...
                            <?php
                              ...
                              ?>
                              <img src="<?php echo $_SESSION['profilephoto'] ?> " class="img-fluid" width="30" height="30" style=" border-radius: 20px;" alt="profile photo">
                            <?php
                              }
                              ?></a>
                         </li>
